...
Page({
  ...
  onLoad: function (t) {
    ...
    i.setData({
      ...
      if (console.log(t), 0 == t.error) {
        ...
        }), d = e.getCache("orderShop"), console.log(222);
        d && i.setData({
          "list.carrierInfo": d,
          "list.storeInfo": d
  ...
  caculate: function (t) {
    ...
    e.data.data && 0 != e.data.data.couponid && (i = e.data.data.couponid), a.post("order/create/caculate", {
      ...
      discountprice: this.data.list.discountprice,
      cardid: this.data.cardid ? this.data.cardid : 0,
      couponid: i
    }, function (a) {
      console.log(74747)
      console.error(a), t.dispatch_price = a.price, t.enoughdeduct = a.deductenough_money,
        ...
        (!e.data.goods.giftid) && e.setData({
          "goods.gifts": a.gifts
        }), t.realprice <= 0 && (t.realprice = 1e-6), t.realprice = s.toFixed(a.realprice, 2),
        e.setData({
          list: t,
          "list.isonlyverifygoods": !1,
          cardid: a.card_info.cardid == null ? 0 : a.card_info.cardid,
  ...
  submit: function () {
    ...
    var t = this.data,
      ...
      d = t.giftid;
    console.log(4);
    var addessid = t.list.address.id ? t.list.address.id : r.id;
    ...
    if (0 == this.data.goods.giftid && 1 == this.data.goods.gifts.length && (d = this.data.goods.gifts[0].id),
      ...
      var o = {
        ...
        carrierid: 0 == t.data.dispatchtype && t.list.carrierInfo ? t.list.carrierInfo.id : 0,
        addressid: addessid ? addessid : r.id,
        carriers: 0 == t.data.dispatchtype && (t.list.isvirtual || t.list.isverify) ? {
        ...
        fromquick: t.fromquick,
        isPack: this.data.isPack == false ? 0 : 1,
      };
      if (t.list.storeInfo && (o.carrierid = t.list.storeInfo.id), 0 == t.data.dispatchtype || t.list.isvirtual || t.list.isverify) {
        ...
        0 == t.data.dispatchtype && (o.addressid = 0);
        1 == t.data.dispatchtype && (o.carrierid = 0);
